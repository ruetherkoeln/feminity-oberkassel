...
## 1. Basisdaten (NAP) — exakt so übernehmen

Diese Angaben müssen **wortgleich** mit der Website übereinstimmen (Name, Adresse, Telefon). Die Website wurde am 2026-05-18 auf die korrekten Öffnungszeiten angepasst.
...
## 3. Kategorien (wichtigster lokaler Rankingfaktor)

GBP erlaubt **1 Hauptkategorie + bis zu 9 Zusatzkategorien**. Die Hauptkategorie bestimmt maßgeblich, für welche Suchen das Profil im lokalen 3er-Pack erscheint.

**Empfohlene Hauptkategorie:** `Friseur`
> Begründung: „friseur oberkassel" / „friseur düsseldorf oberkassel" sind laut Search Console die stärksten Nicht-Marken-Suchanfragen. Wenn der Beauty-Bereich umsatzstärker ist, alternativ `Schönheitssalon` als Haupt — dann Friseur als erste Zusatzkategorie.

**Zusatzkategorien (so viele zutreffende wie möglich):**
- Schönheitssalon
- Kosmetikstudio
- Permanent-Make-up-Studio
- Haarentfernungsservice
- Visagist / Make-up-Artist
- Hautpflegeklinik / Medical Spa *(nur wenn zutreffend)*
- Day Spa *(nur wenn zutreffend)*

> Nur Kategorien wählen, die ihr tatsächlich anbietet. Falsche Kategorien schaden.

---

## 4. Unternehmensbeschreibung (max. 750 Zeichen)
...
Im Dashboard unter „Leistungen" — pro Kategorie Services anlegen. Name + Kurzbeschreibung (Beschreibung optional, aber empfohlen).

**Friseur**
- Damenhaarschnitt — Schnitt inkl. Wäsche, Pflege und Föhnen
- Coloration & Balayage — von Wurzeltonung bis zur freihändigen Balayage-Technik
...
**Permanent Make-up**
- Powder Brows — softe, gepuderte Augenbrauen
- Lip Blush — natürliche Lippenkontur und -tönung
- Brow Lamination / Browlifting
...
- ✅ Bezahloptionen: Karte, kontaktlos, ggf. mobile Zahlungen *(prüfen)*
- ✅ Toilette für Kundinnen
- ✅ LGBTQ-freundlich *(optional, falls passend)*

> Attribute, die ihr nicht sicher beurteilen könnt (Parken, Barrierefreiheit), vor Ort prüfen, bevor ihr sie setzt.
...
**Regeln:** echte Fotos (keine Stockbilder), gute Belichtung, regelmäßig neue hochladen (1–2× pro Monat hält das Profil „aktiv").

---

## 8. GBP-Posts (Vorlagen)

Posts laufen ~7 Tage prominent — Ziel: alle 1–2 Wochen ein Post. Vier fertige Vorlagen:
...
**Post B — Behandlung im Fokus**
```
Dauerhafte Haarentfernung mit dem Nd:YAG-Laser – geeignet für alle
Hauttypen, auch gebräunte Haut. Ehrliche Beratung, realistische
Erwartungen, kein Verkaufsdruck. Mehr im Blog.
```
→ Button: „Mehr Infos" → Link auf den Laser-Blogbeitrag

**Post C — Saisonal / Aktuell**
```
Frischer Start in den Sommer: Balayage für den natürlichsten Look
des Jahres. Freihändig aufgetragene Farbe, die mitwächst. Sichert
Euch einen Termin bei Nicky.
```
→ Button: „Termin buchen"

**Post D — Produkt / Neuheit**
```
Neu bei Feminity: HH Simonsen Profi-Tools – die dänische Salonqualität,
mit der wir arbeiten, jetzt auch für Zuhause erhältlich.
```
→ Button: „Mehr Infos"

---

## 9. Fragen & Antworten (vorbefüllen)

Im GBP kann der Inhaber selbst Fragen stellen UND beantworten. Diese 6 vorab anlegen:

**F: Kann ich online einen Termin buchen?**
...
**F: Bietet Ihr Permanent Make-up an?**
A: Ja – Powder Brows, Lip Blush und Brow Lamination gehören zu unserem festen Angebot.

---

## 10. Bewertungsstrategie

Die 4,9-Sterne-Basis halten und ausbauen — Bewertungen sind nach Kategorie & Nähe der drittwichtigste Local-Rankingfaktor.

- **Aktiv fragen:** zufriedene Kundinnen direkt nach dem Termin um eine Google-Bewertung bitten. Kurzlink/QR-Code aus dem GBP-Dashboard generieren (an der Kasse / per WhatsApp nach dem Termin).
- **Auf ALLE Bewertungen antworten** — positive wie negative, zeitnah, persönlich. Antworten sind ein Rankingsignal und zeigen Interessenten, dass ihr euch kümmert.
- **Bei negativen Bewertungen:** sachlich, freundlich, lösungsorientiert antworten — nie defensiv.
- Kein Anreiz/Kauf für Bewertungen (Google-Richtlinienverstoß).

---

## 11. Laufende Pflege — Monats-Checkliste

- [ ] 2–4 neue Fotos hochgeladen
- [ ] 1–2 GBP-Posts veröffentlicht
- [ ] Alle neuen Bewertungen beantwortet
- [ ] Neue Kundenfragen beantwortet
- [ ] Öffnungszeiten geprüft (v. a. vor Feiertagen)
- [ ] NAP-Daten = identisch mit Website
- [ ] Bei neuen Leistungen: Service-Liste ergänzt

---

## Offene Punkte zum Verifizieren

Diese Angaben kann ich nicht aus der Website ableiten — bitte vor Ort/selbst prüfen:
- Barrierefreiheit, Parkmöglichkeiten, WLAN
- Akzeptierte Zahlungsarten
- Vollständige Team-Liste für Fotos
- Ob „Schönheitssalon" oder „Friseur" die umsatzstärkere und damit bessere Hauptkategorie ist
